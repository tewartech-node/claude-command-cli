...
describe('Request Validation & Security', () => {
  describe('request structure validation', () => {
    ...
    it('rejects requests without command or encrypted_data', () => {
      ...
      expect(() => validateRequestStructure(request)).toThrow('Missing command');
    });
    ...
    it('rejects non-object requests', () => {
      expect(() => validateRequestStructure(null)).toThrow('Invalid request structure');
      expect(() => validateRequestStructure('string')).toThrow('Invalid request structure');
      expect(() => validateRequestStructure([])).toThrow('Invalid request structure');
    });
  });
  ...
  describe('timestamp validation', () => {
    ...
    it('rejects invalid timestamp format', () => {
      expect(() => validateTimestamp('not-a-date')).toThrow('Invalid timestamp');
